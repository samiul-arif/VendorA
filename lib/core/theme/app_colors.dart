...
class AppColors {
  ...
  // ── Brand Accent Tokens (Claude "Crail" Palette) ────────────────────────
  static const Color primary =
      Color(0xFFD97757); // Crail — warm terracotta orange
  static const Color primaryContainer =
      Color(0xFFC15F3C); // Deeper burnt terracotta
  static const Color primaryDark = Color(0xFFA85A3F); // Dark variant
  static const Color primaryLight =
      Color(0xFFE89B7D); // Gradient end / light variant
  static const Color primaryFixed = Color(0xFFF4D6C2); // Soft pastel pill
  static const Color primaryTint =
      Color(0xFFFAF1EA); // Subtle bg tint for badges (light)
  static const Color primaryTintDark =
      Color(0xFF2E1E17); // Subtle bg tint for badges (dark)
  static const Color primarySurface =
      Color(0xFFF4E5DA); // Light accent card surface

  static const Color secondary =
      Color(0xFF6B6255); // Warm taupe / secondary accent
  static const Color secondaryContainer =
      Color(0xFFB1ADA1); // Cloudy — muted warm grey
  ...
  static const LinearGradient primaryGradient = LinearGradient(
    ...
    colors: [Color(0xFFC15F3C), Color(0xFFE89B7D)],
  );

  static const LinearGradient heroGradient = LinearGradient(
    begin: Alignment.topLeft,
    end: Alignment.bottomRight,
    colors: [Color(0xFFD97757), Color(0xFFF4C28E)],
  );
  ...
  static const Color ctaPrimaryLight =
      Color(0xFF141413); // Near-black solid pill
  ...
  static const Color lightCanvas =
      Color(0xFFFAF9F5); // Pampas — warm parchment bg
  static const Color lightSurface = Color(0xFFFFFFFF); // Primary card surface
  static const Color lightSurfaceSubtle =
      Color(0xFFF4F3EE); // Warm surface-container
  static const Color lightSurfaceLow =
      Color(0xFFF7F6F1); // Surface-container-low
  static const Color lightSurfaceHigh =
      Color(0xFFEDEBE3); // Surface-container-high
  static const Color lightSurfaceHighest =
      Color(0xFFE4E1D7); // Surface-container-highest
  ...
  static const Color darkCanvas =
      Color(0xFF141413); // App background, warm near-black
  static const Color darkSurface = Color(0xFF1C1B19); // Level 1 — base cards
  static const Color darkSurfaceElevated =
      Color(0xFF242220); // Level 2 — modals, sheets, popovers
  static const Color darkSurfaceHighest =
      Color(0xFF2E2B27); // Level 3 — nested/hover surfaces
  ...
  static const Color textPrimaryLight =
      Color(0xFF1F1E1D); // Near-black, warm undertone
  static const Color textSecondaryLight = Color(0xFF6B6255); // Warm taupe
  static const Color textMutedLight =
      Color(0xFFB0AEA5); // Cloudy — placeholder/caption
  static const Color textInverseLight =
      Color(0xFFFAF9F5); // Text on dark chips (light theme)

  // ── Typography & Text Tokens (Dark Theme) ─────────────────────────────
  static const Color textPrimaryDark =
      Color(0xFFF3F1EC); // Soft warm white, not pure #FFF
  static const Color textSecondaryDark =
      Color(0xFFB0AEA5); // Cloudy, muted warm grey
  ...
  static const Color statusSuccess =
      Color(0xFF4C7A5E); // Muted sage green (harmonizes w/ warm palette)
  static const Color statusSuccessBgLight = Color(0xFFEEF3EE);
  static const Color statusSuccessBgDark = Color(0xFF1B2620);

  static const Color statusWarning = Color(0xFFC77B3B); // Amber-terracotta
  static const Color statusWarningBgLight = Color(0xFFFBF0E4);
  ...
  static const Color orderPending = Color(0xFFC77B3B); // Amber-terracotta
  ...
  static const Color overlayScrimLight =
      Color(0x66141413); // 40% near-black scrim
  static const Color overlayScrimDark =
      Color(0x99000000); // 60% black scrim (dark needs more)
