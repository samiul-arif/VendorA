...
class MockNotificationRepository extends BaseMockRepository implements INotificationRepository {
  List<NotificationModel> _notifications = [
    NotificationModel(
      ...
      message: r'Alex Johnson placed an order for 2x Truffle Burger ($34.50). Tap to start preparation.',
    ...
    NotificationModel(
      ...
      message: r'Your weekly settlement of $8,420.50 has been transferred to Chase Bank (•••• 4829).',
